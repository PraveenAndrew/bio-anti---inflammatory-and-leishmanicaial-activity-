   ...
   $con = new mysqli($s,$u,$p,$db);
      ...
      if(isset($_POST['upload']))
      {
       ...
       //       images verfication
             ...
             $query = mysqli_query($con,"insert into bio2b(botanicalname,imageoftheplant,familyname,partoftheplantreported,activeconstituents,experimentaldetails,literaturereference) values('$bioName','$image','$familyName','$plantReport','$active','$experiment','$liternature')");
...
<body class="bg-image">
    ...
    <div class="forms">
        ...
        <section class="wrapper">
               <div class="title">
                      Upload Botanical Details(anti-leishmaniasis)
               </div>
    ...
    <div class="backtosearch">
           <a href="http://localhost/msc-projects/bio2b/index.php">back2home</a>
    </div>
