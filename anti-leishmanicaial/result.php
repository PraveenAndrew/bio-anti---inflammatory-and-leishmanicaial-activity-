 ...
 <body class="bg-image">
           ...
           <div class="data_with_viewcount"> 
               <section class="database">
                     <h3>a database of anti-leishmaniasis activity results</h3>
                    ...
                    <?php  
                       ...
                       if(isset($_POST['submit'])) 
                       {
                              ...
                              $query = "select * from bio2b where botanicalname = '$search'";
                              ...
                              if($queryRun->num_rows>0)
                              {
                                   ...
                                   <table>
                                          ...
                                          <tr><th>Active constituents with   anti-leishmaniasis property:</th>
           ...
           <div class="backtosearch">
               <a href="http://localhost/msc-projects/bio2b/index.php">back2search</a>
         </div>
</body>
</html>
